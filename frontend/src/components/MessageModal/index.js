          ...
          {({ touched, errors, isSubmitting, values }) => (
            <Form>
              <DialogContent dividers>
                ...
                <h3>Recurrencia 🔄</h3>
                <p>
                Puedes elegir enviar el mensaje de forma recurrente y elegir el intervalo. Si es un mensaje que se enviará solo una vez, no modifiques nada en esta sección. 📆✉️.
                </p>
                <br />
                <Grid container spacing={1}>
                  <Grid item xs={12} md={4} xl={4}>
                  ...
                  <FormControl size="small" fullWidth variant="outlined">
                      ...
                      <MenuItem value={6}>Enviar un día hábil despué</MenuItem>
                      </Select>
                    </FormControl>
                  </Grid>
                </Grid>
                ...
                {scheduleMessage?.file?.name && (
                  <>
                    <div>
                      <h4>Archivo adjuntado 📎✅: {scheduleMessage?.file?.name}</h4>
                    </div>
                  </>
                )}
              </DialogContent>
