  ...
  useEffect(() => {
    async function fetchData() {
      ...
      if (!planConfigs.plan.useExternalApi) {
        toast.error("¡Esta empresa no tiene permiso para acceder a esta página! Estamos redirigiéndote 🚧");
        setTimeout(() => {
          history.push(`/`)
        }, 1000);
      }
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <b>Body: </b> {"{"} <br></br>
             "number": "51999053124" <br></br>
             "body": "Message" <br></br> 
             "userId": ID de usuario o "" <br></br>
             "queueId": ID Area  ""<br></br>
             "sendSignature": Firmar mensaje - true/false <br></br>
             "closeTicket": Cerrar el ticket - true/false<br></br>
             {"}"} 
          </Typography>
        </Grid>
        <Grid item xs={12} sm={6}>
        ...
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <ul>
              ...
              <li>
                <b>queueId:</b> ID de area ""
              </li>
              <li>
                <b>medias: </b> archivo
              </li>
              <li>
                <b>sendSignature:</b> Firmar mensajetrue/false
              </li>
              <li>
