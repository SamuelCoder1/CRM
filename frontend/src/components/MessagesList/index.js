            ...
            >
              ...
              {!lgpdDeleteMessage && message.isDeleted && (
                <div>
                  ...
                  >🚫 Este mensaje fue borrado por el contacto &nbsp;
                  </span>
                </div>
              )}
                ...
                {message.quotedMsg && renderQuotedMessage(message)}
                {
                  (
                    ...
                    <>
                      ...
                      {!xmlRegex.test(message.body) && (
                        <MarkdownWrapper>{(lgpdDeleteMessage && message.isDeleted) ? "🚫 _Mensaje Borrado_ " :
                          message.body
                        }</MarkdownWrapper>)}
  ...
  <div className={classes.messagesListWrapper} onDragEnter={handleDrag}>
    ...
    {(channel !== "whatsapp" && channel !== undefined) && (
      ...
      >
        ...
        <span>
        Tienes 24 horas para responder después de recibir un mensaje, de acuerdo con las políticas de Facebook ⏳💬.
        </span>
      </div>
    )}
    {loading && (
