...
const WhatsAppModal = ({ open, onClose, whatsAppId }) => {
  ...
  const handleSaveSchedules = async (values) => {
    toast.success("Haz clic en guardar para registrar los cambios 💾✏️");
    setSchedules(values);
  };
                  ...
                  <>
                    ...
                    >
                      <DialogContent>
                        ...
                        <p>Este flujo se activa solo para nuevos contactos, personas que no tienes en tu lista de contactos y que enviaron un mensaje ✉️
                        </p>
                        <FormControl
                          variant="outlined"
                          margin="dense"
                      ...
                      <DialogContent>
                        <h3>Flujo de respuesta estándar 📄✅</h3>
                        <p>La Respuesta Estándar se envía con cualquier carácter diferente a una palabra clave. ⚠️ ¡ATENCIÓN! Se activará si la atención ya está cerrada. ⛔.
