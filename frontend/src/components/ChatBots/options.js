...
export default function VerticalLinearStepper(props) {
  ...
  const handleSaveBot = async (values) => {
    try {
      ...
      toast.success("Bot guardado con éxito! 🤖✅");
      // setActiveStep(-1)
  ...
  const handleDeleteQueue = async (queueId) => {
    try {
      ...
      setGreetingMessageEdit(null);
      setSteps(data);
      toast.success(i18n.t("Area eliminada con éxito! 🕒❌!"));
    } catch (err) {
      toastError(err);
    }
    setSelectedQueue(null);
  ...
  return (
    <div className={classes.root}>
      ...
      >
        {i18n.t("¿Estás seguro? Todas las opciones internas también serán eliminadas. ❗🗑️")}
      </ConfirmationModal>
                          ...
                          >
                                  ...
                                  <Grid xs={12} md={8} item>
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        <MenuItem value={"attendent"}>Colaborador 🧑‍💼</MenuItem>
                            ...
                            {isStepContent && steps.options[index] && (
                              <StepContent>
                                <>
                                  <CustomToolTip
                                    title="El mensaje es obligatorio para avanzar al siguiente nivel. ✉️➡️📈"
                                    content="Si el mensaje no está definido, el bot no continuará adelante. 🚫🤖➡️"
                                  >
