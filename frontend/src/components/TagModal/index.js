									...
									{kanban === 1 && (
										<>
											<Grid item xs={12} md={6} xl={6}>
												<Field
													as={TextField}
													label={i18n.t("Tiempo en horas para redirigir al tablero ⏳🔄🗂️")}
													name="timeLane"
											...
											<Grid item xs={12} md={6} xl={6}>
												...
												>
													...
													<Field
														as={Select}
														label={i18n.t("Tableros 📋🗂️")}
														placeholder={i18n.t("Tableros 📋🗂️")}
											...
											<Grid item xs={12} md={12} xl={12}>
												<Field
													as={TextField}
													label={i18n.t("Mensaje de saludo del tablero 👋🗂️")}
											...
											<Grid item xs={12} md={12} xl={12}>
												...
												>
													<InputLabel id="whatsapp-selection-label">
														{i18n.t("Volver al tablero tras retomar una atención ⬅️🗂️")}
													</InputLabel>
													<Field
														as={Select}
														label={i18n.t("Volver al tablero tras retomar una atención ⬅️🗂️")}
														placeholder={i18n.t("Volver al tablero tras retomar una atención ⬅️🗂️")}
														labelId="whatsapp-selection-label"
														id="rollbackLaneId"
														name="rollbackLaneId"
														style={{ left: "-7px" }}
