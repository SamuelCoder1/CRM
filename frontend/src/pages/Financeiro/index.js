...
// Nuevo componente "Invoice"
const Invoice = ({ invoice, onPayClick }) => {
  const handlePayClick = () => {
    // Aquí puedes abrir el enlace de la factura basado en "invoice.detail"
    // Asegúrate de que "invoice.detail" contenga la URL correcta de la factura.
    // Ejemplo:
  ...
  return (
    <TableRow key={invoice.id}>
      ...
      </TableCell> {/* Agregue esta columna para la fecha de vencimiento 🗓️ */}
      <TableCell align="center">
            ...
            <Table size="small">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="center">Vencimiento 🗓️</TableCell> {/* Agregue esta columna */}
                  <TableCell align="center">Valor 💵</TableCell>
                  <TableCell align="center">Acción ⚙️</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                <>
