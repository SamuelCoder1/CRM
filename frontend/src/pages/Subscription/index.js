        ...
        >
          ...
          <div>
            <TextField
              ...
              // defaultValue={`Su licencia gana hoy ${returnDays(user?.company?.dueDate)} dias!`}
              defaultValue={returnDays(user?.company?.dueDate) === 0 ? `¡Su licencia gana hoy!` : `Su licencia vence en ${returnDays(user?.company?.dueDate)} dias!`}
              fullWidth
              margin="normal"
